...
class ReconhecimentoFacial():
    def __init__(self):
        self.detector_de_face = cv2.CascadeClassifier("../arquivos-cascade//home/emerson/PycharmProjects/FaceRecFlask/FaceRecFlask/Flask/app/controllers/pasta-dos-usuarios/u_1_Emerson/arquivos-imageme-video/vidfeo-face-.mp4")
        self.reconhecedor = "/home/emerson/PycharmProjects/FaceRecFlask/FaceRecFlask/Flask/app/controllers/pasta-dos-usuarios/u_1_Emerson/arquivos-imageme-video/vidfeo-face-.mp4"
        self.reconhecedor.read("../arquivos-de-reconhecimento/classify_eigen_yale.yml")
        self.largura = 50
        self.altura = 50
        self.fonte = cv2.FONT_HERSHEY_COMPLEX_SMALL
        self.camera = cv2.VideoCapture("../arquivos-imagem-e-video/1")
        self.imagem = None
